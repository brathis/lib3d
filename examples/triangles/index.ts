...
function getCameraOrientation(t: number): Lib3dCameraOrientation {
  return {
    vx: new Lib3dVertex({ x: -Math.cos(t), y: 0, z: Math.sin(t) }),
    vy: new Lib3dVertex({ x: 0, y: 1, z: 0 }),
    vz: new Lib3dVertex({ x: -Math.sin(t), y: 0, z: -Math.cos(t) }),
  };
}
...
const t1 = lib3d.addTriangle(
  new Lib3dTriangle({
    v1: new Lib3dVertex({ x: 1, y: 1, z: -1 }),
    v2: new Lib3dVertex({ x: 1, y: 0, z: -1 }),
    v3: new Lib3dVertex({ x: 0, y: 1, z: -1 }),
...
const t2 = lib3d.addTriangle(
  new Lib3dTriangle({
    v1: new Lib3dVertex({ x: 1, y: 1, z: -1 }),
    v2: new Lib3dVertex({ x: 1, y: 1, z: 0 }),
    v3: new Lib3dVertex({ x: 0, y: 1, z: -1 }),
...
const t3 = lib3d.addTriangle(
  new Lib3dTriangle({
    v1: new Lib3dVertex({ x: 1, y: 0, z: -1 }),
    v2: new Lib3dVertex({ x: 1, y: 1, z: 0 }),
    v3: new Lib3dVertex({ x: 0, y: 1, z: -1 }),
...
const t4 = lib3d.addTriangle(
  new Lib3dTriangle({
    v1: new Lib3dVertex({ x: 1, y: 1, z: -1 }),
    v2: new Lib3dVertex({ x: 1, y: 0, z: -1 }),
    v3: new Lib3dVertex({ x: 1, y: 1, z: 0 }),
...
const lx = lib3d.addLine(
  new Lib3dLine({
    ...
    v2: new Lib3dVertex({ x: 1, y: 0, z: 0 }),
    c: { r: 1, g: 0, b: 0, a: 1 },
  })
);
const ly = lib3d.addLine(
  new Lib3dLine({
    v1: new Lib3dVertex({ x: 0, y: 0, z: 0 }),
    v2: new Lib3dVertex({ x: 0, y: 1, z: 0 }),
    c: { r: 0, g: 1, b: 0, a: 1 },
  })
);
const lz = lib3d.addLine(
  new Lib3dLine({
    v1: new Lib3dVertex({ x: 0, y: 0, z: 0 }),
    v2: new Lib3dVertex({ x: 0, y: 0, z: 1 }),
    c: { r: 0, g: 0, b: 1, a: 1 },
  })
);
